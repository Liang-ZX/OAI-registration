...
def add_names_to_image_data(image_data,folderFlag):
    ...
    image_data[vessel + "mask_file_name"]           = image_data["reference_root"] + "_" + vessel + ".mha"
    image_data[vessel + "dil_mask_file_name"]       = image_data["reference_root"] + "_" + vessel + "_" + str(image_data["dilate_radius"]) + ".mha"
    image_data[vessel + "levelset_mask_file_name"] = image_data["reference_root"] + "_" + vessel + "_levelSet.mha"
    ...
    image_data[vessel + "spline_name"]         = vessel + "_spline.mha"
    ...
    image_data[vessel + "m_rigid_name"]         = vessel + "_rigidMask.mha"
    image_data[vessel + "m_similarity_name"]    = vessel + "_similarityMask.mha"
    image_data[vessel + "m_spline_name"]        = vessel + "_splineMask.mha"
    image_data[vessel + "mask"]                 = vessel + "_mask.mha"
    image_data[vessel + "mask"]                 = image_data["moving_root"] + "_" + vessel + ".mha"
    ...
    image_data[vessel + "spline_transf_name"]      = "TransformParameters."  + vessel + "_spline.txt"
    image_data[vessel + "i_spline_transf_name"]    = "iTransformParameters." + vessel + "_spline.txt"
    image_data[vessel + "m_spline_transf_name"]    = "mTransformParameters." + vessel + "_spline.txt"
